...
add_action( 'admin_menu', function()  {
    add_menu_page( 'Cus Placeholder', 'Cus Placeholder', 'manage_options', untrailingslashit( dirname( __FILE__ ) ).'/ns_admin_option_dashboard.php', '', plugin_dir_url( __FILE__ ).'img/backend-sidebar-icon.png', 60);
